...
# Init Network
yolov3_tiny_face = DarknetImplementation("darknet/yolov3-face.cfg", "darknet/yolov3-face_final.weights")
...
print(" - Face detection(With YOLOv3): {:.4f}s ({:.2f} fps)".format(average_time, 1 / average_time))
